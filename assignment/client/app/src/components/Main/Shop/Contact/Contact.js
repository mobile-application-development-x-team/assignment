        ...
        return (
            <View style={wrapper}>
                <View style={mapContainer}>
                    ...
                    >
                        <MapView.Marker
                            coordinate={{ latitude: 10.7936912, longitude: 106.6501223 }}
                ...
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>xx Truong Chinh/ Tan Binh Dist</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0977777779</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>administrator@gmail.com</Text>
                    </View>
