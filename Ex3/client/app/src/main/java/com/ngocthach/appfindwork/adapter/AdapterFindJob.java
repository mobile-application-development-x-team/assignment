...
public class AdapterFindJob extends  RecyclerView.Adapter {
    ...
    public AdapterFindJob(Activity activity, List<ItemJob> jobList, RecyclerView mRecyclerView, setOnClickItemListener mSetOnClickItemListener){
